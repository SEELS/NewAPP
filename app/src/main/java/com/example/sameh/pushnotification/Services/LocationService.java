package com.example.sameh.pushnotification.Services;
...
public class LocationService extends Service
{
    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void saveLocation(double lat , double lon , double speed)
        {
            ...
            String roadId = sharedPreferences.getString("roadId","");

            String url = "https://seelsapp.herokuapp.com/"+lat+"/"+lon+"/"+speed+"/"+driverId+"/"+tripId+"/"+roadId+"/saveLocation";
